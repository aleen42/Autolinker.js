    ...
    ***************************************************************************** */
    ...
    var EmailMatcher = /** @class */ (function (_super) {
        ...
        function EmailMatcher(cfg) {
             ...
             */
            _this.strictTldEmailMatch = true;
            _this.strictTldEmailMatch = cfg.strictTldEmailMatch;
            return _this;
        }
        /**
         * @inheritdoc
        ...
        EmailMatcher.prototype.parseMatches = function (text) {
            var tagBuilder = this.tagBuilder, localPartCharRegex = this.localPartCharRegex, strictTldRegex = this.strictTldRegex, matches = [], len = text.length, noCurrentEmailMatch = new CurrentEmailMatch(), strictTldEmailMatch = this.strictTldEmailMatch;
            ...
            var charIdx = 0, state = 0 /* State.NonEmailMatch */, currentEmailMatch = noCurrentEmailMatch;
            // For debugging: search for other "For debugging" lines
            ...
            function beginEmailMatch(newState) {
                if (newState === void 0) { newState = 2 /* State.LocalPart */; }
                state = newState;
    ...
    var UrlMatcher = /** @class */ (function (_super) {
        ...
        function UrlMatcher(cfg) {
             ...
             */
            _this.strictTldUrlMatch = false;
            /**
             *  @cfg {boolean} wwwPrefixUrlMatch (required)
             */
            _this.wwwPrefixUrlMatch = false;
            _this.stripPrefix = cfg.stripPrefix;
            _this.stripTrailingSlash = cfg.stripTrailingSlash;
            _this.decodePercentEncoding = cfg.decodePercentEncoding;
            _this.strictTldUrlMatch = cfg.strictTldUrlMatch;
            _this.wwwPrefixUrlMatch = cfg.wwwPrefixUrlMatch;
            return _this;
        }
        /**
         * @inheritdoc
        ...
        UrlMatcher.prototype.parseMatches = function (text) {
            var matcherRegex = this.matcherRegex, stripPrefix = this.stripPrefix, stripTrailingSlash = this.stripTrailingSlash, decodePercentEncoding = this.decodePercentEncoding, tagBuilder = this.tagBuilder, matches = [], match, strictTldUrlMatch = this.strictTldUrlMatch, wwwPrefixUrlMatch = this.wwwPrefixUrlMatch;
            var _loop_1 = function () {
                ...
                if (this_1.matchHasUnbalancedClosingParen(matchStr)) {
                    ...
                    var pos = this_1.matchHasInvalidCharAfterTld(matchStr, schemeUrlMatch, strictTldUrlMatch);
                    if (pos > -1) {
                ...
                if (!protocolUrlMatch && wwwPrefixUrlMatch) {
                    var urlPrefix = matchStr.split('.').shift() || '';
                    var urlNormalized = urlPrefix.toLowerCase();
                    var haveWWW = urlNormalized.match(/www/);
                    if (haveWWW) {
                        var index = haveWWW.index || 0;
         ...
         */
        UrlMatcher.prototype.matchHasInvalidCharAfterTld = function (urlMatch, schemeUrlMatch, strictTldUrlMatch) {
            if (!urlMatch) {
                return -1;
            }
            var offset = 0;
    ...
    var Autolinker = /** @class */ (function () {
        ...
        function Autolinker(cfg) {
             ...
             *     }
             */
            this.strictTld = { urlMatch: false, emailMatch: true };
            /**
         ...
         * @return {Object}
         */
        Autolinker.prototype.normalizeStrictTldCfg = function (strictTld) {
            if (strictTld == null)
                strictTld = true; // default to `true`
        ...
        Autolinker.prototype.getMatchers = function () {
            if (!this.matchers) {
                ...
                var matchers = [
                    ...
                    new EmailMatcher({ tagBuilder: tagBuilder, strictTldEmailMatch: this.strictTld.emailMatch }),
